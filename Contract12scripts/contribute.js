 ...
 * contribute.js
 *
 * Calls saturnsyndicate.contribute() (12_Syndicate.tomb) as a signed
...
const PAYLOAD   = Base16.encode("DEXv4-contribute");
...
async function main() {
  ...
  console.log("  saturnsyndicate.contribute");
  ...
  const args = [
    ...
    0  /* REPLACE: amount/id */,  // amountA: number
    0  /* REPLACE: amount/id */,  // amountB: number
  ];
