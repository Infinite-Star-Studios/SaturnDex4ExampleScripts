...
/**
 * claimSyndicateReward.js
 *
 * Calls saturnsyndicate.claimSyndicateReward() (12_Syndicate.tomb) as a signed
...
const METHOD    = "claimSyndicateReward";

const GAS_PRICE = 100000;
const GAS_LIMIT = 75000;
const PAYLOAD   = Base16.encode("DEXv4-claimSyndicateReward");
...
async function main() {
  ...
  console.log("  saturnsyndicate.claimSyndicateReward");
