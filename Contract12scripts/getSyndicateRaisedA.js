...
/**
 * getSyndicateRaisedA.js
 *
 * Read-only call to saturnsyndicate.getSyndicateRaisedA() (12_Syndicate.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnsyndicate.getSyndicateRaisedA");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getSyndicateRaisedA", ...args]);
