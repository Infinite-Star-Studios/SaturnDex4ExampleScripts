...
/**
 * getSyndicateTokenB.js
 *
 * Read-only call to saturnsyndicate.getSyndicateTokenB() (12_Syndicate.tomb).
 * Returns: string
 *
...
async function main() {
  ...
  console.log("  saturnsyndicate.getSyndicateTokenB");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getSyndicateTokenB", ...args]);
