...
/**
 * getSyndicatePoolId.js
 *
 * Read-only call to saturnsyndicate.getSyndicatePoolId() (12_Syndicate.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnsyndicate.getSyndicatePoolId");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getSyndicatePoolId", ...args]);
