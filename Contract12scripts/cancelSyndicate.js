 ...
 * cancelSyndicate.js
 *
 * Calls saturnsyndicate.cancelSyndicate() (12_Syndicate.tomb) as a signed
...
const METHOD    = "cancelSyndicate";

const GAS_PRICE = 100000;
const GAS_LIMIT = 75000;
const PAYLOAD   = Base16.encode("DEXv4-cancelSyndicate");
...
async function main() {
  ...
  console.log("  saturnsyndicate.cancelSyndicate");
