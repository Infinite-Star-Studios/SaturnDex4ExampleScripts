...
/**
 * getMemberContribution.js
 *
 * Read-only call to saturnsyndicate.getMemberContribution() (12_Syndicate.tomb).
 * Returns: string
 *
...
async function main() {
  ...
  console.log("  saturnsyndicate.getMemberContribution");
  console.log("=".repeat(60));

  const args = [
  0  /* REPLACE: id */,  // syndicateId: number
  Address.FromText("P2K...REPLACE_ME"),  // member: address
];

  const sb = new ScriptBuilder();
  const script = sb
    .BeginScript()
    .CallContract(CONTRACT, "getMemberContribution", args)
    .EndScript();
