...
/**
 * getSyndicateStatus.js
 *
 * Read-only call to saturnsyndicate.getSyndicateStatus() (12_Syndicate.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnsyndicate.getSyndicateStatus");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getSyndicateStatus", ...args]);
