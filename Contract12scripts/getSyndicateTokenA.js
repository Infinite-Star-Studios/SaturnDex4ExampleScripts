...
/**
 * getSyndicateTokenA.js
 *
 * Read-only call to saturnsyndicate.getSyndicateTokenA() (12_Syndicate.tomb).
 * Returns: string
 *
...
async function main() {
  ...
  console.log("  saturnsyndicate.getSyndicateTokenA");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getSyndicateTokenA", ...args]);
