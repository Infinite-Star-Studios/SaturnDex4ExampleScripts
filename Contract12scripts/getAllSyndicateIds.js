...
/**
 * getAllSyndicateIds.js
 *
 * Read-only call to saturnsyndicate.getAllSyndicateIds() (12_Syndicate.tomb).
 * Returns: number*
 *
...
async function main() {
  ...
  console.log("  saturnsyndicate.getAllSyndicateIds");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getAllSyndicateIds", ...args]);
