 ...
 * getSyndicateInfo.js
 *
 * Read-only call to saturnsyndicate.getSyndicateInfo() (12_Syndicate.tomb).
 * Returns: string
 *
...
async function main() {
  ...
  console.log("  saturnsyndicate.getSyndicateInfo");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getSyndicateInfo", ...args]);
