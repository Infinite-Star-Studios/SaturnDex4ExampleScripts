...
/**
 * getNextSyndicateId.js
 *
 * Read-only call to saturnsyndicate.getNextSyndicateId() (12_Syndicate.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnsyndicate.getNextSyndicateId");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getNextSyndicateId", ...args]);
