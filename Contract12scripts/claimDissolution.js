 ...
 * claimDissolution.js
 *
 * Calls saturnsyndicate.claimDissolution() (12_Syndicate.tomb) as a signed
...
const METHOD    = "claimDissolution";

const GAS_PRICE = 100000;
const GAS_LIMIT = 75000;
const PAYLOAD   = Base16.encode("DEXv4-claimDissolution");
...
async function main() {
  ...
  console.log("  saturnsyndicate.claimDissolution");
