...
/**
 * getSyndicateMemberCount.js
 *
 * Read-only call to saturnsyndicate.getSyndicateMemberCount() (12_Syndicate.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnsyndicate.getSyndicateMemberCount");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getSyndicateMemberCount", ...args]);
