...
/**
 * withdrawContribution.js
 *
 * Calls saturnsyndicate.withdrawContribution() (12_Syndicate.tomb) as a signed
...
const METHOD    = "withdrawContribution";

const GAS_PRICE = 100000;
const GAS_LIMIT = 75000;
const PAYLOAD   = Base16.encode("DEXv4-withdrawContribution");
...
async function main() {
  ...
  console.log("  saturnsyndicate.withdrawContribution");
