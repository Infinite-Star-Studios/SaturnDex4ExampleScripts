...
/**
 * dissolveSyndicate.js
 *
 * Calls saturnsyndicate.dissolveSyndicate() (12_Syndicate.tomb) as a signed
...
const METHOD    = "dissolveSyndicate";

const GAS_PRICE = 100000;
const GAS_LIMIT = 75000;
const PAYLOAD   = Base16.encode("DEXv4-dissolveSyndicate");
...
async function main() {
  ...
  console.log("  saturnsyndicate.dissolveSyndicate");
