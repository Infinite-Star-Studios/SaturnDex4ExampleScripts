 ...
 * createSyndicate.js
 *
 * Calls saturnsyndicate.createSyndicate() (12_Syndicate.tomb) as a signed
...
const METHOD    = "createSyndicate";

const GAS_PRICE = 100000;
const GAS_LIMIT = 75000;
const PAYLOAD   = Base16.encode("DEXv4-createSyndicate");
...
async function main() {
  ...
  console.log("  saturnsyndicate.createSyndicate");
  ...
  const args = [
    ...
    "REPLACE_tokenA",  // tokenA: string
    "REPLACE_tokenB",  // tokenB: string
    0  /* REPLACE: amount/id */,  // targetA: number
    0  /* REPLACE: amount/id */,  // targetB: number
    0  /* REPLACE: amount/id */,  // feePer10k: number
  ];
