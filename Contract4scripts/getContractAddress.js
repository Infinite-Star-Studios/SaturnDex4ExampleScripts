 ...
 *
 * Read-only call to saturnswap.getContractAddress() (4_SwapEngine.tomb).
 * Returns: address
 *
...
async function main() {
  ...
  console.log("  saturnswap.getContractAddress");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getContractAddress", ...args]);
