 ...
 * betUnder.js
 *
 * Calls saturnpredict.betUnder() (15_PredictionMarket.tomb) as a signed
...
const METHOD    = "betUnder";

const GAS_PRICE = 100000;
const GAS_LIMIT = 75000;
const PAYLOAD   = Base16.encode("DEXv4-betUnder");
...
async function main() {
  ...
  console.log("  saturnpredict.betUnder");
