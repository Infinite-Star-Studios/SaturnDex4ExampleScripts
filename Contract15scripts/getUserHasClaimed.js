...
/**
 * getUserHasClaimed.js
 *
 * Read-only call to saturnpredict.getUserHasClaimed() (15_PredictionMarket.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnpredict.getUserHasClaimed");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getUserHasClaimed", ...args]);
