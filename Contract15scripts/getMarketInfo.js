 ...
 * getMarketInfo.js
 *
 * Read-only call to saturnpredict.getMarketInfo() (15_PredictionMarket.tomb).
 * Returns: string
 *
...
async function main() {
  ...
  console.log("  saturnpredict.getMarketInfo");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getMarketInfo", ...args]);
