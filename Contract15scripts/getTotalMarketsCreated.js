...
/**
 * getTotalMarketsCreated.js
 *
 * Read-only call to saturnpredict.getTotalMarketsCreated() (15_PredictionMarket.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnpredict.getTotalMarketsCreated");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getTotalMarketsCreated", ...args]);
