 ...
 * getMarketStatus.js
 *
 * Read-only call to saturnpredict.getMarketStatus() (15_PredictionMarket.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnpredict.getMarketStatus");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getMarketStatus", ...args]);
