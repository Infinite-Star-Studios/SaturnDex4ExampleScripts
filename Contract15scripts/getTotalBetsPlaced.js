...
/**
 * getTotalBetsPlaced.js
 *
 * Read-only call to saturnpredict.getTotalBetsPlaced() (15_PredictionMarket.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnpredict.getTotalBetsPlaced");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getTotalBetsPlaced", ...args]);
