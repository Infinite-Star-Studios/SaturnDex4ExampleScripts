...
/**
 * updateProtocolFee.js
 *
 * Calls saturnpredict.updateProtocolFee() (15_PredictionMarket.tomb) as a signed
...
const METHOD    = "updateProtocolFee";

const GAS_PRICE = 100000;
const GAS_LIMIT = 75000;
const PAYLOAD   = Base16.encode("DEXv4-updateProtocolFee");
...
async function main() {
  ...
  console.log("  saturnpredict.updateProtocolFee");
  ...
  const args = [
    0  /* REPLACE: amount/id */,  // newFee: number
  ];
