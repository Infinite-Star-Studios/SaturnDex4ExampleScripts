 ...
 * claimRefund.js
 *
 * Calls saturnpredict.claimRefund() (15_PredictionMarket.tomb) as a signed
...
const METHOD    = "claimRefund";

const GAS_PRICE = 100000;
const GAS_LIMIT = 75000;
const PAYLOAD   = Base16.encode("DEXv4-claimRefund");
...
async function main() {
  ...
  console.log("  saturnpredict.claimRefund");
