...
/**
 * getProtocolFeePer10k.js
 *
 * Read-only call to saturnpredict.getProtocolFeePer10k() (15_PredictionMarket.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnpredict.getProtocolFeePer10k");
  console.log("=".repeat(60));
  ...
  const script = sb
    .BeginScript()
    .CallContract(CONTRACT, "getProtocolFeePer10k", args)
    .EndScript();
