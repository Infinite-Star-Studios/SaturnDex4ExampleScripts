 ...
 * getUserUnderBet.js
 *
 * Read-only call to saturnpredict.getUserUnderBet() (15_PredictionMarket.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnpredict.getUserUnderBet");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getUserUnderBet", ...args]);
