...
/**
 * getMarketMetricType.js
 *
 * Read-only call to saturnpredict.getMarketMetricType() (15_PredictionMarket.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnpredict.getMarketMetricType");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getMarketMetricType", ...args]);
