 ...
 * betOver.js
 *
 * Calls saturnpredict.betOver() (15_PredictionMarket.tomb) as a signed
...
const METHOD    = "betOver";

const GAS_PRICE = 100000;
const GAS_LIMIT = 75000;
const PAYLOAD   = Base16.encode("DEXv4-betOver");
...
async function main() {
  ...
  console.log("  saturnpredict.betOver");
