 ...
 * getMarketEndTime.js
 *
 * Read-only call to saturnpredict.getMarketEndTime() (15_PredictionMarket.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnpredict.getMarketEndTime");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getMarketEndTime", ...args]);
