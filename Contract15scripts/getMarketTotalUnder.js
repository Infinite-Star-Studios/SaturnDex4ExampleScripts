...
/**
 * getMarketTotalUnder.js
 *
 * Read-only call to saturnpredict.getMarketTotalUnder() (15_PredictionMarket.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnpredict.getMarketTotalUnder");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getMarketTotalUnder", ...args]);
