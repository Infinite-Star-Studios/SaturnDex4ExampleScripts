 ...
 * cancelMarket.js
 *
 * Calls saturnpredict.cancelMarket() (15_PredictionMarket.tomb) as a signed
...
const METHOD    = "cancelMarket";

const GAS_PRICE = 100000;
const GAS_LIMIT = 75000;
const PAYLOAD   = Base16.encode("DEXv4-cancelMarket");
...
async function main() {
  ...
  console.log("  saturnpredict.cancelMarket");
