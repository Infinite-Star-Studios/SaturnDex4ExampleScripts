...
/**
 * getMarketThreshold.js
 *
 * Read-only call to saturnpredict.getMarketThreshold() (15_PredictionMarket.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnpredict.getMarketThreshold");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getMarketThreshold", ...args]);
