 ...
 * buyOption.js
 *
 * Calls saturnfeeopts.buyOption() (11_FeeOptions.tomb) as a signed
...
const METHOD    = "buyOption";

const GAS_PRICE = 100000;
const GAS_LIMIT = 75000;
const PAYLOAD   = Base16.encode("DEXv4-buyOption");
...
async function main() {
  ...
  console.log("  saturnfeeopts.buyOption");
