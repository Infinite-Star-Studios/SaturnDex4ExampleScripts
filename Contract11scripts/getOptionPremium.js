 ...
 * getOptionPremium.js
 *
 * Read-only call to saturnfeeopts.getOptionPremium() (11_FeeOptions.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnfeeopts.getOptionPremium");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getOptionPremium", ...args]);
