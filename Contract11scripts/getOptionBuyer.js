 ...
 * getOptionBuyer.js
 *
 * Read-only call to saturnfeeopts.getOptionBuyer() (11_FeeOptions.tomb).
 * Returns: address
 *
...
async function main() {
  ...
  console.log("  saturnfeeopts.getOptionBuyer");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getOptionBuyer", ...args]);
