 ...
 * getOptionWriter.js
 *
 * Read-only call to saturnfeeopts.getOptionWriter() (11_FeeOptions.tomb).
 * Returns: address
 *
...
async function main() {
  ...
  console.log("  saturnfeeopts.getOptionWriter");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getOptionWriter", ...args]);
