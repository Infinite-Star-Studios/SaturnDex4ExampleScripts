 ...
 * getOptionPoolId.js
 *
 * Read-only call to saturnfeeopts.getOptionPoolId() (11_FeeOptions.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnfeeopts.getOptionPoolId");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getOptionPoolId", ...args]);
