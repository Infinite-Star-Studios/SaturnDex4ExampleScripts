 ...
 * cancelListing.js
 *
 * Calls saturnfeeopts.cancelListing() (11_FeeOptions.tomb) as a signed
...
const METHOD    = "cancelListing";

const GAS_PRICE = 100000;
const GAS_LIMIT = 75000;
const PAYLOAD   = Base16.encode("DEXv4-cancelListing");
...
async function main() {
  ...
  console.log("  saturnfeeopts.cancelListing");
