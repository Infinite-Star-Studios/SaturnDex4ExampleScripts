 ...
 * getOptionEndTime.js
 *
 * Read-only call to saturnfeeopts.getOptionEndTime() (11_FeeOptions.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnfeeopts.getOptionEndTime");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getOptionEndTime", ...args]);
