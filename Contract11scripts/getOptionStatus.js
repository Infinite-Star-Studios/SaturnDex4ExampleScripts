 ...
 * getOptionStatus.js
 *
 * Read-only call to saturnfeeopts.getOptionStatus() (11_FeeOptions.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnfeeopts.getOptionStatus");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getOptionStatus", ...args]);
