 ...
 * getAllOptionIds.js
 *
 * Read-only call to saturnfeeopts.getAllOptionIds() (11_FeeOptions.tomb).
 * Returns: number*
 *
...
async function main() {
  ...
  console.log("  saturnfeeopts.getAllOptionIds");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getAllOptionIds", ...args]);
