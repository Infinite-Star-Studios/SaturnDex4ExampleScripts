 ...
 * getNextOptionId.js
 *
 * Read-only call to saturnfeeopts.getNextOptionId() (11_FeeOptions.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnfeeopts.getNextOptionId");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getNextOptionId", ...args]);
