 ...
 * getOptionInfo.js
 *
 * Read-only call to saturnfeeopts.getOptionInfo() (11_FeeOptions.tomb).
 * Returns: string
 *
...
async function main() {
  ...
  console.log("  saturnfeeopts.getOptionInfo");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getOptionInfo", ...args]);
