 ...
 * releaseOption.js
 *
 * Calls saturnfeeopts.releaseOption() (11_FeeOptions.tomb) as a signed
...
const METHOD    = "releaseOption";

const GAS_PRICE = 100000;
const GAS_LIMIT = 75000;
const PAYLOAD   = Base16.encode("DEXv4-releaseOption");
...
async function main() {
  ...
  console.log("  saturnfeeopts.releaseOption");
