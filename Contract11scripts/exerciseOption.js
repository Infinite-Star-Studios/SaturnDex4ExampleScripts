 ...
 * exerciseOption.js
 *
 * Calls saturnfeeopts.exerciseOption() (11_FeeOptions.tomb) as a signed
...
const METHOD    = "exerciseOption";

const GAS_PRICE = 100000;
const GAS_LIMIT = 75000;
const PAYLOAD   = Base16.encode("DEXv4-exerciseOption");
...
async function main() {
  ...
  console.log("  saturnfeeopts.exerciseOption");
  ...
  const args = [
    ...
    0  /* REPLACE: amount/id */,  // optionId: number
  ];
