 ...
 * expireOption.js
 *
 * Calls saturnfeeopts.expireOption() (11_FeeOptions.tomb) as a signed
...
const METHOD    = "expireOption";

const GAS_PRICE = 100000;
const GAS_LIMIT = 75000;
const PAYLOAD   = Base16.encode("DEXv4-expireOption");
...
async function main() {
  ...
  console.log("  saturnfeeopts.expireOption");
