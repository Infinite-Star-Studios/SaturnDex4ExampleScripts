...
/**
 * getOrderMinAmountOut.js
 *
 * Read-only call to saturnlimit.getOrderMinAmountOut() (14_LimitOrders.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnlimit.getOrderMinAmountOut");
  console.log("=".repeat(60));

  const args = [
  0  /* REPLACE: id */,  // orderId: number
];

  const sb = new ScriptBuilder();
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getOrderMinAmountOut", ...args]);
