...
/**
 * getTotalOrdersPlaced.js
 *
 * Read-only call to saturnlimit.getTotalOrdersPlaced() (14_LimitOrders.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnlimit.getTotalOrdersPlaced");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getTotalOrdersPlaced", ...args]);
