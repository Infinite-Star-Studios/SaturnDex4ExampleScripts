 ...
 * getOrderOwner.js
 *
 * Read-only call to saturnlimit.getOrderOwner() (14_LimitOrders.tomb).
 * Returns: address
 *
...
async function main() {
  ...
  console.log("  saturnlimit.getOrderOwner");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getOrderOwner", ...args]);
