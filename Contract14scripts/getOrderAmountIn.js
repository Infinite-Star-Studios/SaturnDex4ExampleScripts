 ...
 * getOrderAmountIn.js
 *
 * Read-only call to saturnlimit.getOrderAmountIn() (14_LimitOrders.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnlimit.getOrderAmountIn");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getOrderAmountIn", ...args]);
