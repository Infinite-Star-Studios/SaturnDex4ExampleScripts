 ...
 * getNextOrderId.js
 *
 * Read-only call to saturnlimit.getNextOrderId() (14_LimitOrders.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnlimit.getNextOrderId");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getNextOrderId", ...args]);
