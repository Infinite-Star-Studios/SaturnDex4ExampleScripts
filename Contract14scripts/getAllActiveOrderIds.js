...
/**
 * getAllActiveOrderIds.js
 *
 * Read-only call to saturnlimit.getAllActiveOrderIds() (14_LimitOrders.tomb).
 * Returns: number*
 *
...
async function main() {
  ...
  console.log("  saturnlimit.getAllActiveOrderIds");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getAllActiveOrderIds", ...args]);
