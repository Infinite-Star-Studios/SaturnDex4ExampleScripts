 ...
 * placeOrder.js
 *
 * Calls saturnlimit.placeOrder() (14_LimitOrders.tomb) as a signed
...
const PAYLOAD   = Base16.encode("DEXv4-placeOrder");
...
async function main() {
  ...
  console.log("  saturnlimit.placeOrder");
  ...
  const args = [
    ...
    0  /* REPLACE: amount/id */,  // bountyPer10k: number
    0  /* REPLACE: amount/id */,  // expiryTime: number
  ];
