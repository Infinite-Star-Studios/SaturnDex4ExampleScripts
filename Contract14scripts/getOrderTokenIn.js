 ...
 * getOrderTokenIn.js
 *
 * Read-only call to saturnlimit.getOrderTokenIn() (14_LimitOrders.tomb).
 * Returns: string
 *
...
async function main() {
  ...
  console.log("  saturnlimit.getOrderTokenIn");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getOrderTokenIn", ...args]);
