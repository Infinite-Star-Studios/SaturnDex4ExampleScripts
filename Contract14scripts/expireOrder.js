 ...
 * expireOrder.js
 *
 * Calls saturnlimit.expireOrder() (14_LimitOrders.tomb) as a signed
...
const METHOD    = "expireOrder";

const GAS_PRICE = 100000;
const GAS_LIMIT = 75000;
const PAYLOAD   = Base16.encode("DEXv4-expireOrder");
...
async function main() {
  ...
  console.log("  saturnlimit.expireOrder");
