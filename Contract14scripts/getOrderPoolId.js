 ...
 * getOrderPoolId.js
 *
 * Read-only call to saturnlimit.getOrderPoolId() (14_LimitOrders.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnlimit.getOrderPoolId");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getOrderPoolId", ...args]);
