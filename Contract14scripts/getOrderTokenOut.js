 ...
 * getOrderTokenOut.js
 *
 * Read-only call to saturnlimit.getOrderTokenOut() (14_LimitOrders.tomb).
 * Returns: string
 *
...
async function main() {
  ...
  console.log("  saturnlimit.getOrderTokenOut");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getOrderTokenOut", ...args]);
