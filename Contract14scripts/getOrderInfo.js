 ...
 * getOrderInfo.js
 *
 * Read-only call to saturnlimit.getOrderInfo() (14_LimitOrders.tomb).
 * Returns: string
 *
...
async function main() {
  ...
  console.log("  saturnlimit.getOrderInfo");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getOrderInfo", ...args]);
