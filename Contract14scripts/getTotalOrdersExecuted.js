...
/**
 * getTotalOrdersExecuted.js
 *
 * Read-only call to saturnlimit.getTotalOrdersExecuted() (14_LimitOrders.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnlimit.getTotalOrdersExecuted");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getTotalOrdersExecuted", ...args]);
