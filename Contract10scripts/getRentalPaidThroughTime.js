...
/**
 * getRentalPaidThroughTime.js
 *
 * Read-only call to saturnrental.getRentalPaidThroughTime() (10_PoolRental.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnrental.getRentalPaidThroughTime");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getRentalPaidThroughTime", ...args]);
