 ...
 * getNextRentalId.js
 *
 * Read-only call to saturnrental.getNextRentalId() (10_PoolRental.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnrental.getNextRentalId");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getNextRentalId", ...args]);
