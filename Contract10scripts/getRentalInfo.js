 ...
 * getRentalInfo.js
 *
 * Read-only call to saturnrental.getRentalInfo() (10_PoolRental.tomb).
 * Returns: string
 *
...
async function main() {
  ...
  console.log("  saturnrental.getRentalInfo");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getRentalInfo", ...args]);
