 ...
 * getAllRentalIds.js
 *
 * Read-only call to saturnrental.getAllRentalIds() (10_PoolRental.tomb).
 * Returns: number*
 *
...
async function main() {
  ...
  console.log("  saturnrental.getAllRentalIds");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getAllRentalIds", ...args]);
