 ...
 * getRentalStatus.js
 *
 * Read-only call to saturnrental.getRentalStatus() (10_PoolRental.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnrental.getRentalStatus");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getRentalStatus", ...args]);
