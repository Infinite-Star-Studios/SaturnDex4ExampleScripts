 ...
 * listForRent.js
 *
 * Calls saturnrental.listForRent() (10_PoolRental.tomb) as a signed
...
const METHOD    = "listForRent";

const GAS_PRICE = 100000;
const GAS_LIMIT = 75000;
const PAYLOAD   = Base16.encode("DEXv4-listForRent");
...
async function main() {
  ...
  console.log("  saturnrental.listForRent");
  ...
  const args = [
    ...
    0  /* REPLACE: amount/id */,  // dailyRate: number
    0  /* REPLACE: amount/id */,  // depositRequired: number
    0  /* REPLACE: amount/id */,  // minFeePer10k: number
    0  /* REPLACE: amount/id */,  // maxFeePer10k: number
    0  /* REPLACE: amount/id */,  // minTermDays: number
  ];
