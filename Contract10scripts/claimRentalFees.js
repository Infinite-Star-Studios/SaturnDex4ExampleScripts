 ...
 * claimRentalFees.js
 *
 * Calls saturnrental.claimRentalFees() (10_PoolRental.tomb) as a signed
...
const METHOD    = "claimRentalFees";

const GAS_PRICE = 100000;
const GAS_LIMIT = 75000;
const PAYLOAD   = Base16.encode("DEXv4-claimRentalFees");
...
async function main() {
  ...
  console.log("  saturnrental.claimRentalFees");
