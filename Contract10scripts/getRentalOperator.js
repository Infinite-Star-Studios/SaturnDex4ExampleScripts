...
/**
 * getRentalOperator.js
 *
 * Read-only call to saturnrental.getRentalOperator() (10_PoolRental.tomb).
 * Returns: address
 *
...
async function main() {
  ...
  console.log("  saturnrental.getRentalOperator");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getRentalOperator", ...args]);
