 ...
 * extendRental.js
 *
 * Calls saturnrental.extendRental() (10_PoolRental.tomb) as a signed
...
const METHOD    = "extendRental";

const GAS_PRICE = 100000;
const GAS_LIMIT = 75000;
const PAYLOAD   = Base16.encode("DEXv4-extendRental");
...
async function main() {
  ...
  console.log("  saturnrental.extendRental");
  ...
  const args = [
    ...
    0  /* REPLACE: amount/id */,  // rentalId: number
    0  /* REPLACE: amount/id */,  // additionalDays: number
  ];
