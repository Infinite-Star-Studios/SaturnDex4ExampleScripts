...
/**
 * getRentalDailyRate.js
 *
 * Read-only call to saturnrental.getRentalDailyRate() (10_PoolRental.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnrental.getRentalDailyRate");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getRentalDailyRate", ...args]);
