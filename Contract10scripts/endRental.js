 ...
 * endRental.js
 *
 * Calls saturnrental.endRental() (10_PoolRental.tomb) as a signed
...
const METHOD    = "endRental";

const GAS_PRICE = 100000;
const GAS_LIMIT = 75000;
const PAYLOAD   = Base16.encode("DEXv4-endRental");
...
async function main() {
  ...
  console.log("  saturnrental.endRental");
