 ...
 * getRentalPoolId.js
 *
 * Read-only call to saturnrental.getRentalPoolId() (10_PoolRental.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnrental.getRentalPoolId");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getRentalPoolId", ...args]);
