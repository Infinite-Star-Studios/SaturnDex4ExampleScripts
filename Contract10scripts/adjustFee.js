 ...
 * adjustFee.js
 *
 * Calls saturnrental.adjustFee() (10_PoolRental.tomb) as a signed
...
const METHOD    = "adjustFee";

const GAS_PRICE = 100000;
const GAS_LIMIT = 75000;
const PAYLOAD   = Base16.encode("DEXv4-adjustFee");
...
async function main() {
  ...
  console.log("  saturnrental.adjustFee");
