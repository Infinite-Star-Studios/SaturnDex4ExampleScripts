 ...
 * collectRent.js
 *
 * Calls saturnrental.collectRent() (10_PoolRental.tomb) as a signed
...
const METHOD    = "collectRent";

const GAS_PRICE = 100000;
const GAS_LIMIT = 75000;
const PAYLOAD   = Base16.encode("DEXv4-collectRent");
...
async function main() {
  ...
  console.log("  saturnrental.collectRent");
