 ...
 * rentPool.js
 *
 * Calls saturnrental.rentPool() (10_PoolRental.tomb) as a signed
...
const METHOD    = "rentPool";

const GAS_PRICE = 100000;
const GAS_LIMIT = 75000;
const PAYLOAD   = Base16.encode("DEXv4-rentPool");
...
async function main() {
  ...
  console.log("  saturnrental.rentPool");
