...
/**
 * getTotalProfitGenerated.js
 *
 * Read-only call to saturnarb.getTotalProfitGenerated() (13_FlashArbitrage.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnarb.getTotalProfitGenerated");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getTotalProfitGenerated", ...args]);
