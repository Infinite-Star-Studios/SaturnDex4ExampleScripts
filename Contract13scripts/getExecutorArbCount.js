...
/**
 * getExecutorArbCount.js
 *
 * Read-only call to saturnarb.getExecutorArbCount() (13_FlashArbitrage.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnarb.getExecutorArbCount");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getExecutorArbCount", ...args]);
