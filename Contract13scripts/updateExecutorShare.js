...
/**
 * updateExecutorShare.js
 *
 * Calls saturnarb.updateExecutorShare() (13_FlashArbitrage.tomb) as a signed
...
const METHOD    = "updateExecutorShare";

const GAS_PRICE = 100000;
const GAS_LIMIT = 75000;
const PAYLOAD   = Base16.encode("DEXv4-updateExecutorShare");
...
async function main() {
  ...
  console.log("  saturnarb.updateExecutorShare");
  ...
  const args = [
    0  /* REPLACE: amount/id */,  // newShare: number
  ];
