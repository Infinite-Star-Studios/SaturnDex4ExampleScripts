...
/**
 * getExecutorSharePer100.js
 *
 * Read-only call to saturnarb.getExecutorSharePer100() (13_FlashArbitrage.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnarb.getExecutorSharePer100");
  console.log("=".repeat(60));
  ...
  const script = sb
    .BeginScript()
    .CallContract(CONTRACT, "getExecutorSharePer100", args)
    .EndScript();
