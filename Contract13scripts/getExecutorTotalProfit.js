...
/**
 * getExecutorTotalProfit.js
 *
 * Read-only call to saturnarb.getExecutorTotalProfit() (13_FlashArbitrage.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnarb.getExecutorTotalProfit");
  console.log("=".repeat(60));

  const args = [
  Address.FromText("P2K...REPLACE_ME"),  // executor: address
];

  const sb = new ScriptBuilder();
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getExecutorTotalProfit", ...args]);
