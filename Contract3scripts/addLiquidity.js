 ...
 * addLiquidity.js
 *
 * Calls saturnliquidity.addLiquidity() (3_LiquidityManager.tomb) as a signed
...
const PAYLOAD   = Base16.encode("DEXv4-addLiquidity");
...
async function main() {
  ...
  console.log("  saturnliquidity.addLiquidity");
  ...
  const args = [
    ...
    10000000000000  /* REPLACE: amount/id */,  // amountTokenA: number
    100000000000  /* REPLACE: amount/id */,  // maxAmountTokenB: number
  ];
