...
/**
 * burnPoolCertificate.js
 *
 * Calls SATURN.burnPoolCertificate() (6_PoolNFT.tomb) as a signed
...
const METHOD    = "burnPoolCertificate";

const GAS_PRICE = 100000;
const GAS_LIMIT = 75000;
const PAYLOAD   = Base16.encode("DEXv4-burnPoolCertificate");
...
async function main() {
  ...
  console.log("  SATURN.burnPoolCertificate");
