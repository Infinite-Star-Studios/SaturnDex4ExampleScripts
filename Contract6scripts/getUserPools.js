 ...
 * getUserPools.js
 *
 * Calls SATURN.getUserPools() (6_PoolNFT.tomb) as a signed
...
const METHOD    = "getUserPools";

const GAS_PRICE = 100000;
const GAS_LIMIT = 75000;
const PAYLOAD   = Base16.encode("DEXv4-getUserPools");
...
async function main() {
  ...
  console.log("  SATURN.getUserPools");
