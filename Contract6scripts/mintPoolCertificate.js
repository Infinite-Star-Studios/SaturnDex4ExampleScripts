...
/**
 * mintPoolCertificate.js
 *
 * Calls SATURN.mintPoolCertificate() (6_PoolNFT.tomb) as a signed
...
const NEXUS     = "testnet";
const CHAIN     = "main";
const CONTRACT  = "SATURN";
const METHOD    = "mintPoolCertificate";

const GAS_PRICE = 100000;
const GAS_LIMIT = 75000;
const PAYLOAD   = Base16.encode("DEXv4-mintPoolCertificate");
...
async function main() {
  ...
  console.log("  SATURN.mintPoolCertificate");
