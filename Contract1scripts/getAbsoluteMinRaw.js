...
/**
 * getAbsoluteMinRaw.js
 *
 * Read-only call to saturnadmin.getAbsoluteMinRaw() (1_AdminConfig.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnadmin.getAbsoluteMinRaw");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getAbsoluteMinRaw", ...args]);
