 ...
 * acquireGuard.js
 *
 * Calls saturnadmin.acquireGuard() (1_AdminConfig.tomb) as a signed
...
const METHOD    = "acquireGuard";

const GAS_PRICE = 100000;
const GAS_LIMIT = 75000;
const PAYLOAD   = Base16.encode("DEXv4-acquireGuard");
...
async function main() {
  ...
  console.log("  saturnadmin.acquireGuard");
