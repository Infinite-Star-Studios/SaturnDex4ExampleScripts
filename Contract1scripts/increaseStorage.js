 ...
 * increaseStorage.js
 *
 * Calls saturnadmin.increaseStorage() (1_AdminConfig.tomb) as a signed
...
const METHOD    = "increaseStorage";

const GAS_PRICE = 100000;
const GAS_LIMIT = 75000;
const PAYLOAD   = Base16.encode("DEXv4-increaseStorage");
...
async function main() {
  ...
  console.log("  saturnadmin.increaseStorage");
  ...
  const args = [
    ...
    0  /* REPLACE: amount/id */,  // stakeAmount: number
    "REPLACE_soultoken",  // soultoken: string
  ];
