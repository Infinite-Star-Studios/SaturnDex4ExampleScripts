 ...
 * getAdminPct.js
 *
 * Read-only call to saturnadmin.getAdminPct() (1_AdminConfig.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnadmin.getAdminPct");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getAdminPct", ...args]);
