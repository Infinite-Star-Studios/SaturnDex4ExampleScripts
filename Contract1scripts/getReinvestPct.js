 ...
 * getReinvestPct.js
 *
 * Read-only call to saturnadmin.getReinvestPct() (1_AdminConfig.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnadmin.getReinvestPct");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getReinvestPct", ...args]);
