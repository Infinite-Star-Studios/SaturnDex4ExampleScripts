...
/**
 * getMinPoolFeePer10k.js
 *
 * Read-only call to saturnadmin.getMinPoolFeePer10k() (1_AdminConfig.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnadmin.getMinPoolFeePer10k");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getMinPoolFeePer10k", ...args]);
