 ...
 * updateSOULfees.js
 *
 * Calls saturnadmin.updateSOULfees() (1_AdminConfig.tomb) as a signed
...
const METHOD    = "updateSOULfees";

const GAS_PRICE = 100000;
const GAS_LIMIT = 75000;
const PAYLOAD   = Base16.encode("DEXv4-updateSOULfees");
...
async function main() {
  ...
  console.log("  saturnadmin.updateSOULfees");
  ...
  const args = [
    0  /* REPLACE: amount/id */,  // newCreatePool: number
    0  /* REPLACE: amount/id */,  // newAddLiquidity: number
  ];
