...
/**
 * getMinScaledAddLiqUnits.js
 *
 * Read-only call to saturnadmin.getMinScaledAddLiqUnits() (1_AdminConfig.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnadmin.getMinScaledAddLiqUnits");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getMinScaledAddLiqUnits", ...args]);
