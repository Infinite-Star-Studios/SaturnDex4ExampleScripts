 ...
 * clearReentrancy.js
 *
 * Calls saturnadmin.clearReentrancy() (1_AdminConfig.tomb) as a signed
...
const METHOD    = "clearReentrancy";

const GAS_PRICE = 100000;
const GAS_LIMIT = 75000;
const PAYLOAD   = Base16.encode("DEXv4-clearReentrancy");
...
async function main() {
  ...
  console.log("  saturnadmin.clearReentrancy");
