 ...
 * getStorageFee.js
 *
 * Read-only call to saturnadmin.getStorageFee() (1_AdminConfig.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnadmin.getStorageFee");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getStorageFee", ...args]);
