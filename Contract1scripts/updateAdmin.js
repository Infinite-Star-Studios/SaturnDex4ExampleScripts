 ...
 * updateAdmin.js
 *
 * Calls saturnadmin.updateAdmin() (1_AdminConfig.tomb) as a signed
...
const PAYLOAD   = Base16.encode("DEXv4-updateAdmin");
...
async function main() {
  ...
  console.log("  saturnadmin.updateAdmin");
  ...
  const args = [
    Address.FromText("P2K...REPLACE_ME"),  // newAdmin: address
  ];
