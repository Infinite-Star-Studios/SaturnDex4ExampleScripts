...
/**
 * updatePoolFeeRange.js
 *
 * Calls saturnadmin.updatePoolFeeRange() (1_AdminConfig.tomb) as a signed
...
const METHOD    = "updatePoolFeeRange";

const GAS_PRICE = 100000;
const GAS_LIMIT = 75000;
const PAYLOAD   = Base16.encode("DEXv4-updatePoolFeeRange");
...
async function main() {
  ...
  console.log("  saturnadmin.updatePoolFeeRange");
  ...
  const args = [
    0  /* REPLACE: amount/id */,  // newMin: number
    0  /* REPLACE: amount/id */,  // newMax: number
  ];
