 ...
 * accrueStorageFee.js
 *
 * Calls saturnadmin.accrueStorageFee() (1_AdminConfig.tomb) as a signed
...
const METHOD    = "accrueStorageFee";

const GAS_PRICE = 100000;
const GAS_LIMIT = 75000;
const PAYLOAD   = Base16.encode("DEXv4-accrueStorageFee");
...
async function main() {
  ...
  console.log("  saturnadmin.accrueStorageFee");
  ...
  const args = [
    0  /* REPLACE: amount/id */,  // feesFromSoul: number
  ];
