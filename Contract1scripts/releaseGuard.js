 ...
 * releaseGuard.js
 *
 * Calls saturnadmin.releaseGuard() (1_AdminConfig.tomb) as a signed
...
const METHOD    = "releaseGuard";

const GAS_PRICE = 100000;
const GAS_LIMIT = 75000;
const PAYLOAD   = Base16.encode("DEXv4-releaseGuard");
...
async function main() {
  ...
  console.log("  saturnadmin.releaseGuard");
