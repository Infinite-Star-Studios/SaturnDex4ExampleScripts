 ...
 * getProviderPct.js
 *
 * Read-only call to saturnadmin.getProviderPct() (1_AdminConfig.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnadmin.getProviderPct");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getProviderPct", ...args]);
