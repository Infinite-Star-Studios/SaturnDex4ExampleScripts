...
/**
 * getMinScaledPoolUnits.js
 *
 * Read-only call to saturnadmin.getMinScaledPoolUnits() (1_AdminConfig.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnadmin.getMinScaledPoolUnits");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getMinScaledPoolUnits", ...args]);
