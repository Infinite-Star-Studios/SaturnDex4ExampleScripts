...
/**
 * updateMaxTruncationPercent.js
 *
 * Calls saturnadmin.updateMaxTruncationPercent() (1_AdminConfig.tomb) as a signed
...
const METHOD    = "updateMaxTruncationPercent";

const GAS_PRICE = 100000;
const GAS_LIMIT = 75000;
const PAYLOAD   = Base16.encode("DEXv4-updateMaxTruncationPercent");
...
async function main() {
  ...
  console.log("  saturnadmin.updateMaxTruncationPercent");
  ...
  const args = [
    0  /* REPLACE: amount/id */,  // newPercent: number
  ];
