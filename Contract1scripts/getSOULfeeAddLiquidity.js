...
/**
 * getSOULfeeAddLiquidity.js
 *
 * Read-only call to saturnadmin.getSOULfeeAddLiquidity() (1_AdminConfig.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnadmin.getSOULfeeAddLiquidity");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getSOULfeeAddLiquidity", ...args]);
