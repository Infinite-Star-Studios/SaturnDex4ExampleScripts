...
/**
 * updateMinScaledAmounts.js
 *
 * Calls saturnadmin.updateMinScaledAmounts() (1_AdminConfig.tomb) as a signed
...
const METHOD    = "updateMinScaledAmounts";

const GAS_PRICE = 100000;
const GAS_LIMIT = 75000;
const PAYLOAD   = Base16.encode("DEXv4-updateMinScaledAmounts");
...
async function main() {
  ...
  console.log("  saturnadmin.updateMinScaledAmounts");
  ...
  const args = [
    0  /* REPLACE: amount/id */,  // newPoolMin: number
    0  /* REPLACE: amount/id */,  // newSwapMin: number
    0  /* REPLACE: amount/id */,  // newAddLiqMin: number
  ];
