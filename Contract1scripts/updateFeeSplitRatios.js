...
/**
 * updateFeeSplitRatios.js
 *
 * Calls saturnadmin.updateFeeSplitRatios() (1_AdminConfig.tomb) as a signed
...
const METHOD    = "updateFeeSplitRatios";

const GAS_PRICE = 100000;
const GAS_LIMIT = 75000;
const PAYLOAD   = Base16.encode("DEXv4-updateFeeSplitRatios");
...
async function main() {
  ...
  console.log("  saturnadmin.updateFeeSplitRatios");
  ...
  const args = [
    0  /* REPLACE: amount/id */,  // newReinvest: number
    0  /* REPLACE: amount/id */,  // newProvider: number
    0  /* REPLACE: amount/id */,  // newAdmin: number
  ];
