 ...
 *
 * Read-only call to saturnadmin.getMaxTruncationPercent() (1_AdminConfig.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnadmin.getMaxTruncationPercent");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallContract(CONTRACT, "getMaxTruncationPercent", args);
