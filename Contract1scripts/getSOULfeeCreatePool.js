...
/**
 * getSOULfeeCreatePool.js
 *
 * Read-only call to saturnadmin.getSOULfeeCreatePool() (1_AdminConfig.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnadmin.getSOULfeeCreatePool");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getSOULfeeCreatePool", ...args]);
