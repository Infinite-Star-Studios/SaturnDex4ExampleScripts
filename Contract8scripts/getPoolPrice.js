 ...
 * getPoolPrice.js
 *
 * Read-only call to saturnrouter.getPoolPrice() (8_RouterViews.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnrouter.getPoolPrice");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getPoolPrice", ...args]);
