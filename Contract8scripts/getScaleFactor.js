 ...
 * getScaleFactor.js
 *
 * Read-only call to saturnrouter.getScaleFactor() (8_RouterViews.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnrouter.getScaleFactor");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getScaleFactor", ...args]);
