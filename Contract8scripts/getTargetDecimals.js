...
/**
 * getTargetDecimals.js
 *
 * Read-only call to saturnrouter.getTargetDecimals() (8_RouterViews.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnrouter.getTargetDecimals");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getTargetDecimals", ...args]);
