...
/**
 * getPoolCountForPair.js
 *
 * Read-only call to saturnrouter.getPoolCountForPair() (8_RouterViews.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnrouter.getPoolCountForPair");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getPoolCountForPair", ...args]);
