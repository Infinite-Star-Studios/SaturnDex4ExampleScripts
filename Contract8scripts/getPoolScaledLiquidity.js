...
/**
 * getPoolScaledLiquidity.js
 *
 * Read-only call to saturnrouter.getPoolScaledLiquidity() (8_RouterViews.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnrouter.getPoolScaledLiquidity");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getPoolScaledLiquidity", ...args]);
