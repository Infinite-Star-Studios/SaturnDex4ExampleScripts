 ...
 * getMinRawForSwap.js
 *
 * Read-only call to saturnrouter.getMinRawForSwap() (8_RouterViews.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnrouter.getMinRawForSwap");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getMinRawForSwap", ...args]);
