...
/**
 * getMinRawForAddLiquidity.js
 *
 * Read-only call to saturnrouter.getMinRawForAddLiquidity() (8_RouterViews.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnrouter.getMinRawForAddLiquidity");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getMinRawForAddLiquidity", ...args]);
