...
/**
 * getMinRawForPoolCreation.js
 *
 * Read-only call to saturnrouter.getMinRawForPoolCreation() (8_RouterViews.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnrouter.getMinRawForPoolCreation");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getMinRawForPoolCreation", ...args]);
