 ...
 * getPoolFeeRange.js
 *
 * Read-only call to saturnrouter.getPoolFeeRange() (8_RouterViews.tomb).
 * Returns: string
 *
...
async function main() {
  ...
  console.log("  saturnrouter.getPoolFeeRange");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getPoolFeeRange", ...args]);
