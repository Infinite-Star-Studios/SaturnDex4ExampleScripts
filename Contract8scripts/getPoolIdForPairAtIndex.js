...
/**
 * getPoolIdForPairAtIndex.js
 *
 * Read-only call to saturnrouter.getPoolIdForPairAtIndex() (8_RouterViews.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnrouter.getPoolIdForPairAtIndex");
  console.log("=".repeat(60));

  const args = [
  "REPLACE_tokenA",  // tokenA: string
  "REPLACE_tokenB",  // tokenB: string
  0  /* REPLACE: id */,  // index: number
];

  const sb = new ScriptBuilder();
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getPoolIdForPairAtIndex", ...args]);
