 ...
 * getPoolFullInfo.js
 *
 * Read-only call to saturnrouter.getPoolFullInfo() (8_RouterViews.tomb).
 * Returns: string
 *
...
async function main() {
  ...
  console.log("  saturnrouter.getPoolFullInfo");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getPoolFullInfo", ...args]);
