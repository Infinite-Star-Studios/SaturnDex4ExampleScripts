 ...
 * unpawnPool.js
 *
 * Calls saturnpools.unpawnPool() (2_PoolRegistry.tomb) as a signed
...
const METHOD    = "unpawnPool";

const GAS_PRICE = 100000;
const GAS_LIMIT = 75000;
const PAYLOAD   = Base16.encode("DEXv4-unpawnPool");
...
async function main() {
  ...
  console.log("  saturnpools.unpawnPool");
