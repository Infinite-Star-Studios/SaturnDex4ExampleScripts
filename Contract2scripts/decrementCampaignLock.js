...
/**
 * decrementCampaignLock.js
 *
 * Calls saturnpools.decrementCampaignLock() (2_PoolRegistry.tomb) as a signed
...
const METHOD    = "decrementCampaignLock";

const GAS_PRICE = 100000;
const GAS_LIMIT = 75000;
const PAYLOAD   = Base16.encode("DEXv4-decrementCampaignLock");
...
async function main() {
  ...
  console.log("  saturnpools.decrementCampaignLock");
