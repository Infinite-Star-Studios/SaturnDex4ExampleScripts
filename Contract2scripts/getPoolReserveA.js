 ...
 * getPoolReserveA.js
 *
 * Read-only call to saturnpools.getPoolReserveA() (2_PoolRegistry.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnpools.getPoolReserveA");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getPoolReserveA", ...args]);
