...
/**
 * getMinRawForToken.js
 *
 * Read-only call to saturnpools.getMinRawForToken() (2_PoolRegistry.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnpools.getMinRawForToken");
  console.log("=".repeat(60));

  const args = [
  "REPLACE_symbol",  // symbol: string
  0  /* REPLACE: id */,  // minScaledUnits: number
];

  const sb = new ScriptBuilder();
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getMinRawForToken", ...args]);
