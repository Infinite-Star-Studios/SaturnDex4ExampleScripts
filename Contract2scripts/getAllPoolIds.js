 ...
 * getAllPoolIds.js
 *
 * Read-only call to saturnpools.getAllPoolIds() (2_PoolRegistry.tomb).
 * Returns: number*
 *
...
async function main() {
  ...
  console.log("  saturnpools.getAllPoolIds");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getAllPoolIds", ...args]);
