...
/**
 * getTokensInDEXList.js
 *
 * Read-only call to saturnpools.getTokensInDEXList() (2_PoolRegistry.tomb).
 * Returns: string*
 *
...
async function main() {
  ...
  console.log("  saturnpools.getTokensInDEXList");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getTokensInDEXList", ...args]);
