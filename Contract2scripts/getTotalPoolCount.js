...
/**
 * getTotalPoolCount.js
 *
 * Read-only call to saturnpools.getTotalPoolCount() (2_PoolRegistry.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnpools.getTotalPoolCount");
  console.log("=".repeat(60));
  ...
  const script = sb
    .BeginScript()
    .CallContract(CONTRACT, "getTotalPoolCount", args)
    .EndScript();
