...
/**
 * clearPoolReserves.js
 *
 * Calls saturnpools.clearPoolReserves() (2_PoolRegistry.tomb) as a signed
...
const METHOD    = "clearPoolReserves";

const GAS_PRICE = 100000;
const GAS_LIMIT = 75000;
const PAYLOAD   = Base16.encode("DEXv4-clearPoolReserves");
...
async function main() {
  ...
  console.log("  saturnpools.clearPoolReserves");
