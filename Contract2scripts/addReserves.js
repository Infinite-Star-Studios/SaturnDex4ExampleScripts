 ...
 * addReserves.js
 *
 * Calls saturnpools.addReserves() (2_PoolRegistry.tomb) as a signed
...
const METHOD    = "addReserves";

const GAS_PRICE = 100000;
const GAS_LIMIT = 75000;
const PAYLOAD   = Base16.encode("DEXv4-addReserves");
...
async function main() {
  ...
  console.log("  saturnpools.addReserves");
  ...
  const args = [
    ...
    0  /* REPLACE: amount/id */,  // scaledAddA: number
    0  /* REPLACE: amount/id */,  // scaledAddB: number
  ];
