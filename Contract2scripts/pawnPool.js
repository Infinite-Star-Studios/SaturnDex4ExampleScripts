 ...
 * pawnPool.js
 *
 * Calls saturnpools.pawnPool() (2_PoolRegistry.tomb) as a signed
...
const METHOD    = "pawnPool";

const GAS_PRICE = 100000;
const GAS_LIMIT = 75000;
const PAYLOAD   = Base16.encode("DEXv4-pawnPool");
...
async function main() {
  ...
  console.log("  saturnpools.pawnPool");
