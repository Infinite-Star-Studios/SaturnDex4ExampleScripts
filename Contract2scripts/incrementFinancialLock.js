...
/**
 * incrementFinancialLock.js
 *
 * Calls saturnpools.incrementFinancialLock() (2_PoolRegistry.tomb) as a signed
...
const METHOD    = "incrementFinancialLock";

const GAS_PRICE = 100000;
const GAS_LIMIT = 75000;
const PAYLOAD   = Base16.encode("DEXv4-incrementFinancialLock");
...
async function main() {
  ...
  console.log("  saturnpools.incrementFinancialLock");
