 ...
 * registerPool.js
 *
 * Calls saturnpools.registerPool() (2_PoolRegistry.tomb) as a signed
...
const METHOD    = "registerPool";

const GAS_PRICE = 100000;
const GAS_LIMIT = 75000;
const PAYLOAD   = Base16.encode("DEXv4-registerPool");
...
async function main() {
  ...
  console.log("  saturnpools.registerPool");
  ...
  const args = [
    ...
    "REPLACE_token0Symbol",  // token0Symbol: string
    "REPLACE_token1Symbol",  // token1Symbol: string
    0  /* REPLACE: amount/id */,  // scaledAmount0: number
    0  /* REPLACE: amount/id */,  // scaledAmount1: number
    0  /* REPLACE: amount/id */,  // customFeePer10k: number
  ];
