 ...
 * getPoolReserveB.js
 *
 * Read-only call to saturnpools.getPoolReserveB() (2_PoolRegistry.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnpools.getPoolReserveB");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getPoolReserveB", ...args]);
