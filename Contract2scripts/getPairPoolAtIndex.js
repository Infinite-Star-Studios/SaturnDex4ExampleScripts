...
/**
 * getPairPoolAtIndex.js
 *
 * Read-only call to saturnpools.getPairPoolAtIndex() (2_PoolRegistry.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnpools.getPairPoolAtIndex");
  console.log("=".repeat(60));

  const args = [
  "REPLACE_lookupKey",  // lookupKey: string
];

  const sb = new ScriptBuilder();
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getPairPoolAtIndex", ...args]);
