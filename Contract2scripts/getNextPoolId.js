 ...
 * getNextPoolId.js
 *
 * Read-only call to saturnpools.getNextPoolId() (2_PoolRegistry.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnpools.getNextPoolId");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getNextPoolId", ...args]);
