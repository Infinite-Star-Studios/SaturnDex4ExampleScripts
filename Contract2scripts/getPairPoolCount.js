 ...
 * getPairPoolCount.js
 *
 * Read-only call to saturnpools.getPairPoolCount() (2_PoolRegistry.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnpools.getPairPoolCount");
  console.log("=".repeat(60));

  const args = [
  "REPLACE_pairKey",  // pairKey: string
];

  const sb = new ScriptBuilder();
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getPairPoolCount", ...args]);
