 ...
 * scaleDown.js
 *
 * Read-only call to saturnpools.scaleDown() (2_PoolRegistry.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnpools.scaleDown");
  console.log("=".repeat(60));

  const args = [
  0  /* REPLACE: id */,  // amount: number
  "REPLACE_symbol",  // symbol: string
];

  const sb = new ScriptBuilder();
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "scaleDown", ...args]);
