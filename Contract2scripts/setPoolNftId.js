 ...
 * setPoolNftId.js
 *
 * Calls saturnpools.setPoolNftId() (2_PoolRegistry.tomb) as a signed
...
const METHOD    = "setPoolNftId";

const GAS_PRICE = 100000;
const GAS_LIMIT = 75000;
const PAYLOAD   = Base16.encode("DEXv4-setPoolNftId");
...
async function main() {
  ...
  console.log("  saturnpools.setPoolNftId");
  ...
  const args = [
    ...
    0  /* REPLACE: amount/id */,  // nftId: number
  ];
