...
/**
 * setReservesAfterSwap.js
 *
 * Calls saturnpools.setReservesAfterSwap() (2_PoolRegistry.tomb) as a signed
...
const METHOD    = "setReservesAfterSwap";

const GAS_PRICE = 100000;
const GAS_LIMIT = 75000;
const PAYLOAD   = Base16.encode("DEXv4-setReservesAfterSwap");
...
async function main() {
  ...
  console.log("  saturnpools.setReservesAfterSwap");
  ...
  const args = [
    ...
    0  /* REPLACE: amount/id */,  // newResA: number
    0  /* REPLACE: amount/id */,  // newResB: number
    "REPLACE_tokenIn",  // tokenIn: string
    "REPLACE_tokenOut",  // tokenOut: string
    0  /* REPLACE: amount/id */,  // scaledInDelta: number
    0  /* REPLACE: amount/id */,  // scaledOutDelta: number
  ];
