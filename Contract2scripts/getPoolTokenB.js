 ...
 * getPoolTokenB.js
 *
 * Read-only call to saturnpools.getPoolTokenB() (2_PoolRegistry.tomb).
 * Returns: string
 *
...
async function main() {
  ...
  console.log("  saturnpools.getPoolTokenB");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getPoolTokenB", ...args]);
