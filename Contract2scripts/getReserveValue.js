 ...
 * getReserveValue.js
 *
 * Read-only call to saturnpools.getReserveValue() (2_PoolRegistry.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnpools.getReserveValue");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getReserveValue", ...args]);
