 ...
 *
 * Read-only call to saturnpools.getContractTokenBalanceEach() (2_PoolRegistry.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnpools.getContractTokenBalanceEach");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getContractTokenBalanceEach", ...args]);
