...
/**
 * decrementFinancialLock.js
 *
 * Calls saturnpools.decrementFinancialLock() (2_PoolRegistry.tomb) as a signed
...
const METHOD    = "decrementFinancialLock";

const GAS_PRICE = 100000;
const GAS_LIMIT = 75000;
const PAYLOAD   = Base16.encode("DEXv4-decrementFinancialLock");
...
async function main() {
  ...
  console.log("  saturnpools.decrementFinancialLock");
