...
/**
 * validateTokenSymbol.js
 *
 * Calls saturnpools.validateTokenSymbol() (2_PoolRegistry.tomb) as a signed
...
const METHOD    = "validateTokenSymbol";

const GAS_PRICE = 100000;
const GAS_LIMIT = 75000;
const PAYLOAD   = Base16.encode("DEXv4-validateTokenSymbol");
...
async function main() {
  ...
  console.log("  saturnpools.validateTokenSymbol");
