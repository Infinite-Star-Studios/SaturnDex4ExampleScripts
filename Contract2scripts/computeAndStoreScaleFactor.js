...
/**
 * computeAndStoreScaleFactor.js
 *
 * Calls saturnpools.computeAndStoreScaleFactor() (2_PoolRegistry.tomb) as a signed
...
const METHOD    = "computeAndStoreScaleFactor";

const GAS_PRICE = 100000;
const GAS_LIMIT = 75000;
const PAYLOAD   = Base16.encode("DEXv4-computeAndStoreScaleFactor");
...
async function main() {
  ...
  console.log("  saturnpools.computeAndStoreScaleFactor");
