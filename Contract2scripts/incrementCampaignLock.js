...
/**
 * incrementCampaignLock.js
 *
 * Calls saturnpools.incrementCampaignLock() (2_PoolRegistry.tomb) as a signed
...
const METHOD    = "incrementCampaignLock";

const GAS_PRICE = 100000;
const GAS_LIMIT = 75000;
const PAYLOAD   = Base16.encode("DEXv4-incrementCampaignLock");
...
async function main() {
  ...
  console.log("  saturnpools.incrementCampaignLock");
