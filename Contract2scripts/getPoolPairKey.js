 ...
 * getPoolPairKey.js
 *
 * Read-only call to saturnpools.getPoolPairKey() (2_PoolRegistry.tomb).
 * Returns: string
 *
...
async function main() {
  ...
  console.log("  saturnpools.getPoolPairKey");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getPoolPairKey", ...args]);
