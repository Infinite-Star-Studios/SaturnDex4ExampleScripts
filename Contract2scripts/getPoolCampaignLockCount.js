...
/**
 * getPoolCampaignLockCount.js
 *
 * Read-only call to saturnpools.getPoolCampaignLockCount() (2_PoolRegistry.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnpools.getPoolCampaignLockCount");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getPoolCampaignLockCount", ...args]);
