...
/**
 * getPairsInDEXList.js
 *
 * Read-only call to saturnpools.getPairsInDEXList() (2_PoolRegistry.tomb).
 * Returns: string*
 *
...
async function main() {
  ...
  console.log("  saturnpools.getPairsInDEXList");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getPairsInDEXList", ...args]);
