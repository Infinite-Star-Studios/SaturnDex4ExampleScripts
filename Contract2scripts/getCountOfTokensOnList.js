...
/**
 * getCountOfTokensOnList.js
 *
 * Read-only call to saturnpools.getCountOfTokensOnList() (2_PoolRegistry.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnpools.getCountOfTokensOnList");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getCountOfTokensOnList", ...args]);
