...
/**
 * getPoolFinancialLockCount.js
 *
 * Read-only call to saturnpools.getPoolFinancialLockCount() (2_PoolRegistry.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnpools.getPoolFinancialLockCount");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getPoolFinancialLockCount", ...args]);
