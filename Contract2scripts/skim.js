 ...
 * skim.js
 *
 * Calls saturnpools.skim() (2_PoolRegistry.tomb) as a signed
...
const PAYLOAD   = Base16.encode("DEXv4-skim");
...
async function main() {
  ...
  const args = [
    ...
    "REPLACE_tokentoskim",  // tokentoskim: string
  ];
