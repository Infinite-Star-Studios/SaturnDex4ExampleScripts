 ...
 * getPoolNftId.js
 *
 * Read-only call to saturnpools.getPoolNftId() (2_PoolRegistry.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnpools.getPoolNftId");
  console.log("=".repeat(60));

  const args = [
  1  /* REPLACE: id */,  // poolId: number
];

  const sb = new ScriptBuilder();
  sb.BeginScript();
  sb.CallContract(CONTRACT, "getPoolNftId", args);
