 ...
 * getPoolPawned.js
 *
 * Read-only call to saturnpools.getPoolPawned() (2_PoolRegistry.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnpools.getPoolPawned");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getPoolPawned", ...args]);
