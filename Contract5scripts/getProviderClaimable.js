 ...
 *
 * Read-only call to saturnfees.getProviderClaimable() (5_FeeVault.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnfees.getProviderClaimable");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getProviderClaimable", ...args]);
