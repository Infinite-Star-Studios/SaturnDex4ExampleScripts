...
/**
 * claimRedirectedFees.js
 *
 * Read-only call to saturnfees.claimRedirectedFees() (5_FeeVault.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnfees.claimRedirectedFees");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "claimRedirectedFees", ...args]);
