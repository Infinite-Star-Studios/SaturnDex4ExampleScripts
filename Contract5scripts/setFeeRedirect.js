 ...
 * setFeeRedirect.js
 *
 * Calls saturnfees.setFeeRedirect() (5_FeeVault.tomb) as a signed
...
const METHOD    = "setFeeRedirect";

const GAS_PRICE = 100000;
const GAS_LIMIT = 75000;
const PAYLOAD   = Base16.encode("DEXv4-setFeeRedirect");
...
async function main() {
  ...
  console.log("  saturnfees.setFeeRedirect");
  ...
  const args = [
    ...
    0  /* REPLACE: amount/id */,  // active: number
  ];
