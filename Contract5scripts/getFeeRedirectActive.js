...
/**
 * getFeeRedirectActive.js
 *
 * Read-only call to saturnfees.getFeeRedirectActive() (5_FeeVault.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnfees.getFeeRedirectActive");
  console.log("=".repeat(60));
  ...
  const script = sb
    .BeginScript()
    .CallContract(CONTRACT, "getFeeRedirectActive", args)
    .EndScript();
