...
/**
 * claimAndReturnFees.js
 *
 * Read-only call to saturnfees.claimAndReturnFees() (5_FeeVault.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnfees.claimAndReturnFees");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "claimAndReturnFees", ...args]);
