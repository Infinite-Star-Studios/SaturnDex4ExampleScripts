...
/**
 * claimProviderFees.js
 *
 * Calls saturnfees.claimProviderFees() (5_FeeVault.tomb) as a signed
...
const METHOD    = "claimProviderFees";

const GAS_PRICE = 100000;
const GAS_LIMIT = 75000;
const PAYLOAD   = Base16.encode("DEXv4-claimProviderFees");
...
async function main() {
  ...
  console.log("  saturnfees.claimProviderFees");
