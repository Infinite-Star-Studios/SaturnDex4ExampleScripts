...
/**
 * accrueProviderFee.js
 *
 * Calls saturnfees.accrueProviderFee() (5_FeeVault.tomb) as a signed
...
const NEXUS     = "testnet";
const CHAIN     = "main";
const CONTRACT  = "saturnfees";
const METHOD    = "accrueProviderFee";

const GAS_PRICE = 100000;
const GAS_LIMIT = 75000;
const PAYLOAD   = Base16.encode("DEXv4-accrueProviderFee");
...
async function main() {
  ...
  console.log("  saturnfees.accrueProviderFee");
  ...
  const args = [
    ...
    0  /* REPLACE: amount/id */,  // scaledProviderFee: number
  ];
