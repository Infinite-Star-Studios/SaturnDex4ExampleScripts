...
/**
 * getVaultTotalDeposits.js
 *
 * Read-only call to saturnvaults.getVaultTotalDeposits() (16_AgentVaults.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnvaults.getVaultTotalDeposits");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getVaultTotalDeposits", ...args]);
