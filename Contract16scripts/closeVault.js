 ...
 * closeVault.js
 *
 * Calls saturnvaults.closeVault() (16_AgentVaults.tomb) as a signed
...
const METHOD    = "closeVault";

const GAS_PRICE = 100000;
const GAS_LIMIT = 75000;
const PAYLOAD   = Base16.encode("DEXv4-closeVault");
...
async function main() {
  ...
  console.log("  saturnvaults.closeVault");
