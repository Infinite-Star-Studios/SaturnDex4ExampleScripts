...
/**
 * getTotalVaultsCreated.js
 *
 * Read-only call to saturnvaults.getTotalVaultsCreated() (16_AgentVaults.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnvaults.getTotalVaultsCreated");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getTotalVaultsCreated", ...args]);
