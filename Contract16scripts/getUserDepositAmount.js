...
/**
 * getUserDepositAmount.js
 *
 * Read-only call to saturnvaults.getUserDepositAmount() (16_AgentVaults.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnvaults.getUserDepositAmount");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getUserDepositAmount", ...args]);
