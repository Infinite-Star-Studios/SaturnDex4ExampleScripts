 ...
 * createVault.js
 *
 * Calls saturnvaults.createVault() (16_AgentVaults.tomb) as a signed
...
const METHOD    = "createVault";

const GAS_PRICE = 100000;
const GAS_LIMIT = 75000;
const PAYLOAD   = Base16.encode("DEXv4-createVault");
...
async function main() {
  ...
  console.log("  saturnvaults.createVault");
  ...
  const args = [
    ...
    "REPLACE_baseToken",  // baseToken: string
    0  /* REPLACE: amount/id */,  // perfFeePer10k: number
    0  /* REPLACE: amount/id */,  // minDeposit: number
  ];
