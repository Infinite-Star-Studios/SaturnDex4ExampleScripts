 ...
 * forceCloseVault.js
 *
 * Calls saturnvaults.forceCloseVault() (16_AgentVaults.tomb) as a signed
...
const METHOD    = "forceCloseVault";

const GAS_PRICE = 100000;
const GAS_LIMIT = 75000;
const PAYLOAD   = Base16.encode("DEXv4-forceCloseVault");
...
async function main() {
  ...
  console.log("  saturnvaults.forceCloseVault");
