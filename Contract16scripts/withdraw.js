 ...
 * withdraw.js
 *
 * Calls saturnvaults.withdraw() (16_AgentVaults.tomb) as a signed
...
const PAYLOAD   = Base16.encode("DEXv4-withdraw");
...
async function main() {
  ...
  console.log("  saturnvaults.withdraw");
  ...
  const args = [
    ...
    0  /* REPLACE: amount/id */,  // sharesToRedeem: number
  ];
