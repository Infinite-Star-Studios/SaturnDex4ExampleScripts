 ...
 * getAllVaultIds.js
 *
 * Read-only call to saturnvaults.getAllVaultIds() (16_AgentVaults.tomb).
 * Returns: number*
 *
...
async function main() {
  ...
  console.log("  saturnvaults.getAllVaultIds");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getAllVaultIds", ...args]);
