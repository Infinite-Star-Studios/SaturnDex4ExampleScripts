...
/**
 * getVaultBaseToken.js
 *
 * Read-only call to saturnvaults.getVaultBaseToken() (16_AgentVaults.tomb).
 * Returns: string
 *
...
async function main() {
  ...
  console.log("  saturnvaults.getVaultBaseToken");
  console.log("=".repeat(60));
  ...
  const script = sb
    .BeginScript()
    .CallContract(CONTRACT, "getVaultBaseToken", args)
    .EndScript();
