 ...
 * getVaultStatus.js
 *
 * Read-only call to saturnvaults.getVaultStatus() (16_AgentVaults.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnvaults.getVaultStatus");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getVaultStatus", ...args]);
