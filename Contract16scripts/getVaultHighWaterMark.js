...
/**
 * getVaultHighWaterMark.js
 *
 * Read-only call to saturnvaults.getVaultHighWaterMark() (16_AgentVaults.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnvaults.getVaultHighWaterMark");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getVaultHighWaterMark", ...args]);
