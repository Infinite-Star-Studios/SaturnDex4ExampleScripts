...
/**
 * getVaultPerfFeePer10k.js
 *
 * Read-only call to saturnvaults.getVaultPerfFeePer10k() (16_AgentVaults.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnvaults.getVaultPerfFeePer10k");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getVaultPerfFeePer10k", ...args]);
