...
/**
 * getVaultTotalShares.js
 *
 * Read-only call to saturnvaults.getVaultTotalShares() (16_AgentVaults.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnvaults.getVaultTotalShares");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getVaultTotalShares", ...args]);
