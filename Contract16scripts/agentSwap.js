 ...
 * agentSwap.js
 *
 * Calls saturnvaults.agentSwap() (16_AgentVaults.tomb) as a signed
...
const METHOD    = "agentSwap";

const GAS_PRICE = 100000;
const GAS_LIMIT = 75000;
const PAYLOAD   = Base16.encode("DEXv4-agentSwap");
...
async function main() {
  ...
  console.log("  saturnvaults.agentSwap");
