...
/**
 * getCampaignActive.js
 *
 * Read-only call to saturnrewards.getCampaignActive() (7_RewardCampaigns.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnrewards.getCampaignActive");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getCampaignActive", ...args]);
