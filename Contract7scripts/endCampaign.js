 ...
 * endCampaign.js
 *
 * Calls saturnrewards.endCampaign() (7_RewardCampaigns.tomb) as a signed
...
const METHOD    = "endCampaign";

const GAS_PRICE = 100000;
const GAS_LIMIT = 75000;
const PAYLOAD   = Base16.encode("DEXv4-endCampaign");
...
async function main() {
  ...
  console.log("  saturnrewards.endCampaign");
