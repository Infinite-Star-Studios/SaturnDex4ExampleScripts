...
/**
 * getCampaignRewardTotal.js
 *
 * Read-only call to saturnrewards.getCampaignRewardTotal() (7_RewardCampaigns.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnrewards.getCampaignRewardTotal");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getCampaignRewardTotal", ...args]);
