 ...
 * enrollInCampaign.js
 *
 * Calls saturnrewards.enrollInCampaign() (7_RewardCampaigns.tomb) as a signed
...
const METHOD    = "enrollInCampaign";

const GAS_PRICE = 100000;
const GAS_LIMIT = 75000;
const PAYLOAD   = Base16.encode("DEXv4-enrollInCampaign");
...
async function main() {
  ...
  console.log("  saturnrewards.enrollInCampaign");
