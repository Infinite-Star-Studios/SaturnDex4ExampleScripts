...
/**
 * getPoolCampaignClaimed.js
 *
 * Read-only call to saturnrewards.getPoolCampaignClaimed() (7_RewardCampaigns.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnrewards.getPoolCampaignClaimed");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getPoolCampaignClaimed", ...args]);
