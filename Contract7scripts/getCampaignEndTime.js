...
/**
 * getCampaignEndTime.js
 *
 * Read-only call to saturnrewards.getCampaignEndTime() (7_RewardCampaigns.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnrewards.getCampaignEndTime");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getCampaignEndTime", ...args]);
