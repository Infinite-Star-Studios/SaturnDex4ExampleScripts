...
/**
 * getAllCampaignIds.js
 *
 * Read-only call to saturnrewards.getAllCampaignIds() (7_RewardCampaigns.tomb).
 * Returns: number*
 *
...
async function main() {
  ...
  console.log("  saturnrewards.getAllCampaignIds");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getAllCampaignIds", ...args]);
