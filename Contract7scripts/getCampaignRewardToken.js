...
/**
 * getCampaignRewardToken.js
 *
 * Read-only call to saturnrewards.getCampaignRewardToken() (7_RewardCampaigns.tomb).
 * Returns: string
 *
...
async function main() {
  ...
  console.log("  saturnrewards.getCampaignRewardToken");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getCampaignRewardToken", ...args]);
