...
/**
 * getPoolEnrolledInCampaign.js
 *
 * Read-only call to saturnrewards.getPoolEnrolledInCampaign() (7_RewardCampaigns.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnrewards.getPoolEnrolledInCampaign");
  console.log("=".repeat(60));

  const args = [
  0  /* REPLACE: id */,  // poolId: number
  0  /* REPLACE: id */,  // campaignId: number
];

  const sb = new ScriptBuilder();
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getPoolEnrolledInCampaign", ...args]);
