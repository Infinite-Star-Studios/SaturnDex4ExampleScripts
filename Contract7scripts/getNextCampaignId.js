...
/**
 * getNextCampaignId.js
 *
 * Read-only call to saturnrewards.getNextCampaignId() (7_RewardCampaigns.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnrewards.getNextCampaignId");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getNextCampaignId", ...args]);
