 ...
 * createCampaign.js
 *
 * Calls saturnrewards.createCampaign() (7_RewardCampaigns.tomb) as a signed
...
const NEXUS     = "testnet";
const CHAIN     = "main";
const CONTRACT  = "saturnrewards";
const METHOD    = "createCampaign";

const GAS_PRICE = 100000;
const GAS_LIMIT = 75000;
const PAYLOAD   = Base16.encode("DEXv4-createCampaign");
...
async function main() {
  ...
  console.log("  saturnrewards.createCampaign");
  ...
  const args = [
    ...
    "REPLACE_rewardToken",  // rewardToken: string
    0  /* REPLACE: amount/id */,  // rewardAmount: number
