...
/**
 * getPoolCampaignLiquidity.js
 *
 * Read-only call to saturnrewards.getPoolCampaignLiquidity() (7_RewardCampaigns.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnrewards.getPoolCampaignLiquidity");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getPoolCampaignLiquidity", ...args]);
