...
/**
 * getCampaignTotalLocked.js
 *
 * Read-only call to saturnrewards.getCampaignTotalLocked() (7_RewardCampaigns.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnrewards.getCampaignTotalLocked");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getCampaignTotalLocked", ...args]);
