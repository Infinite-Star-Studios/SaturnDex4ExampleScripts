...
/**
 * getExpectedReward.js
 *
 * Read-only call to saturnrewards.getExpectedReward() (7_RewardCampaigns.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnrewards.getExpectedReward");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getExpectedReward", ...args]);
