 ...
 * getCampaignInfo.js
 *
 * Read-only call to saturnrewards.getCampaignInfo() (7_RewardCampaigns.tomb).
 * Returns: string
 *
...
async function main() {
  ...
  console.log("  saturnrewards.getCampaignInfo");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getCampaignInfo", ...args]);
