 ...
 * listBond.js
 *
 * Calls saturnbonds.listBond() (9_BondMarket.tomb) as a signed
...
const METHOD    = "listBond";

const GAS_PRICE = 100000;
const GAS_LIMIT = 75000;
const PAYLOAD   = Base16.encode("DEXv4-listBond");
...
async function main() {
  ...
  console.log("  saturnbonds.listBond");
  ...
  const args = [
    ...
    0  /* REPLACE: amount/id */,  // faceValue: number
    0  /* REPLACE: amount/id */,  // purchasePrice: number
    "REPLACE_feeToken",  // feeToken: string
    0  /* REPLACE: amount/id */,  // durationSeconds: number
    0  /* REPLACE: amount/id */,  // mode: number
    0  /* REPLACE: amount/id */,  // collateralAmount: number
  ];
