...
/**
 * getBondMaturityTime.js
 *
 * Read-only call to saturnbonds.getBondMaturityTime() (9_BondMarket.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnbonds.getBondMaturityTime");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getBondMaturityTime", ...args]);
