 ...
 * getBondFeeToken.js
 *
 * Read-only call to saturnbonds.getBondFeeToken() (9_BondMarket.tomb).
 * Returns: string
 *
...
async function main() {
  ...
  console.log("  saturnbonds.getBondFeeToken");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getBondFeeToken", ...args]);
