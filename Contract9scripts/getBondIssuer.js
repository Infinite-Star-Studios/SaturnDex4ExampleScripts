 ...
 * getBondIssuer.js
 *
 * Read-only call to saturnbonds.getBondIssuer() (9_BondMarket.tomb).
 * Returns: address
 *
...
async function main() {
  ...
  console.log("  saturnbonds.getBondIssuer");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getBondIssuer", ...args]);
