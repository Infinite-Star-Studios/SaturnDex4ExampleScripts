 ...
 * getBondStatus.js
 *
 * Read-only call to saturnbonds.getBondStatus() (9_BondMarket.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnbonds.getBondStatus");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getBondStatus", ...args]);
