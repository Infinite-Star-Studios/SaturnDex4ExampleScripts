 ...
 * getBondBuyer.js
 *
 * Read-only call to saturnbonds.getBondBuyer() (9_BondMarket.tomb).
 * Returns: address
 *
...
async function main() {
  ...
  console.log("  saturnbonds.getBondBuyer");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getBondBuyer", ...args]);
