...
/**
 * getBondPurchasePrice.js
 *
 * Read-only call to saturnbonds.getBondPurchasePrice() (9_BondMarket.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnbonds.getBondPurchasePrice");
  console.log("=".repeat(60));

  const args = [
  0  /* REPLACE: id */,  // bondId: number
];

  const sb = new ScriptBuilder();
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getBondPurchasePrice", ...args]);
