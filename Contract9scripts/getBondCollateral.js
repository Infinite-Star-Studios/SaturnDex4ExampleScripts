...
/**
 * getBondCollateral.js
 *
 * Read-only call to saturnbonds.getBondCollateral() (9_BondMarket.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnbonds.getBondCollateral");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getBondCollateral", ...args]);
