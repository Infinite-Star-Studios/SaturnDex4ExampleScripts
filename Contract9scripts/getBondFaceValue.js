 ...
 * getBondFaceValue.js
 *
 * Read-only call to saturnbonds.getBondFaceValue() (9_BondMarket.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnbonds.getBondFaceValue");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getBondFaceValue", ...args]);
