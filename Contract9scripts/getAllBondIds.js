 ...
 * getAllBondIds.js
 *
 * Read-only call to saturnbonds.getAllBondIds() (9_BondMarket.tomb).
 * Returns: number*
 *
...
async function main() {
  ...
  console.log("  saturnbonds.getAllBondIds");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getAllBondIds", ...args]);
