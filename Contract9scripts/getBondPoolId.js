 ...
 * getBondPoolId.js
 *
 * Read-only call to saturnbonds.getBondPoolId() (9_BondMarket.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnbonds.getBondPoolId");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getBondPoolId", ...args]);
