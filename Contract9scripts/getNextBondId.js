 ...
 * getNextBondId.js
 *
 * Read-only call to saturnbonds.getNextBondId() (9_BondMarket.tomb).
 * Returns: number
 *
...
async function main() {
  ...
  console.log("  saturnbonds.getNextBondId");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getNextBondId", ...args]);
