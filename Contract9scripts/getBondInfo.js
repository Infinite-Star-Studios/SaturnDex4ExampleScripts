 ...
 * getBondInfo.js
 *
 * Read-only call to saturnbonds.getBondInfo() (9_BondMarket.tomb).
 * Returns: string
 *
...
async function main() {
  ...
  console.log("  saturnbonds.getBondInfo");
  console.log("=".repeat(60));
  ...
  sb.BeginScript();
  sb.CallInterop("Runtime.CallContext", [CONTRACT, "getBondInfo", ...args]);
